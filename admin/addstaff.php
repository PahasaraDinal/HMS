...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO staff (staff_id, name, phone_no, role)
          VALUES ('$staff_id', '$name', '$phone_no', '$role')";
        ...
        <div class="container">
                ...
                <div class="card-body">
                    ...
                    <form id="adddoctorform" action="#" method="post" novalidate autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputDocID">Staff member ID</label>
                            <input type="text" class="form-control" id="inputStaffID" name="staff_id"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="name"
                                placeholder="Enter staf member name" required />
                        </div>
                        <!-- End Input Name -->
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputGroup">Phone Number</label>
                            <input type="tel" class="form-control" id="inputtel" name="phone_no"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputRole" name="role"
                                placeholder="Enter Staff Role" required />
                        </div>
                        <!-- End speciality -->
            ...
            <script>
                ...
                function displayAlertBox() {
                    alert("Staff member add successful");
                }
            </script>
